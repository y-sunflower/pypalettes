...
from parsers.scrape_paletteer import get_paletteer_palettes
from parsers.matplot_and_seaborn import get_matplotlib_and_seaborn_palettes
from parsers.manual_palettes import get_manual_palettes
